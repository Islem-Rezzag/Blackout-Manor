...
describe("client-game package", () => {
  ...
  it("exposes a replaceable client asset manifest for the manor renderer", () => {
    ...
    expect(assetKeys).toContain("prop-kitchen-dish-shelf");
    expect(assetKeys).toContain("prop-study-desk-premium");
    expect(assetKeys).toContain("prop-study-side-table");
    expect(assetKeys).toContain("prop-ballroom-mask-wall");
    expect(assetKeys).toContain("prop-ballroom-bench");
    expect(assetKeys).toContain("prop-greenhouse-planter-bed");
    expect(assetKeys).toContain("prop-greenhouse-hanging-basket");
    expect(assetKeys).toContain("prop-surveillance-desk");
    expect(assetKeys).toContain("prop-surveillance-cable-rack");
    expect(assetKeys).toContain("prop-surveillance-reel-stack");
    expect(assetKeys).toContain("prop-generator-breaker-wall");
    expect(assetKeys).toContain("prop-generator-cable-bundle");
    expect(assetKeys).toContain("prop-cellar-boiler-premium");
    expect(assetKeys).toContain("prop-cellar-workbench");
    expect(assetKeys).toContain("prop-service-trolley");
    expect(assetKeys).toContain("prop-service-hamper");
  ...
  it("maps bespoke manor surfaces and thresholds to the environment pass", () => {
    ...
    expect(kitchenArt.supportProps).toHaveLength(2);
    ...
    expect(libraryArt.supportProps).toHaveLength(0);
    ...
    expect(studyArt.supportProps).toHaveLength(2);
    ...
    expect(ballroomArt.supportProps).toHaveLength(2);
    ...
    expect(greenhouseArt.supportProps).toHaveLength(2);
    ...
    expect(surveillanceArt.supportProps).toHaveLength(3);
    ...
    expect(generatorArt.supportProps).toHaveLength(2);
    ...
    expect(cellarArt.supportProps).toHaveLength(2);
    ...
    expect(servantsCorridorArt.supportProps).toHaveLength(2);
